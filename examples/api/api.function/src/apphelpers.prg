...
// ============================================================
// UEnforceJson — 415 if request body is not JSON when required.
// Call at the top of any controller that reads a body.
// ============================================================
FUNCTION UEnforceJson()

   LOCAL cCt := Lower( UHeader( "Content-Type", "" ) )
